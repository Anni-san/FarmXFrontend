...
const dummyCrops = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1546470427-0fd5f8b1a444?q=80&w=1200&auto=format&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1591449828088-9fa7a6a8a6b1?q=80&w=1200&auto=format&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1500937386664-56f2068d42c6?q=80&w=1200&auto=format&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1546549039-49e07e7f27e5?q=80&w=1200&auto=format&fit=crop',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex gap-6 h-[calc(100vh-4rem)]">
        <motion.aside initial={{ x: -20, opacity: 0 }} animate={{ x: 0, opacity: 1 }} transition={{ duration: 0.4 }} className="hidden md:block w-64 bg-white/80 dark:bg-gray-800/80 backdrop-blur rounded-2xl border border-emerald-100 dark:border-gray-700 shadow-sm p-4 h-full sticky top-20 overflow-auto" >
          ...
          <nav className="space-y-2">
            {['Dashboard','Add Crop','My Crops','Settings'].map(item => (
              <button key={item} onClick={() => { setActiveNav(item); if (item === 'Add Crop') setShowCropForm(true) }} className={`w-full text-left px-4 py-3 rounded-xl transition-all duration-200 ${activeNav===item ? 'bg-emerald-100 text-emerald-700 dark:bg-gray-700 dark:text-emerald-100' : 'hover:bg-emerald-50 dark:hover:bg-gray-700 text-gray-700 dark:text-emerald-100/80'}`}>{item}</button>
            ))}
          </nav>
